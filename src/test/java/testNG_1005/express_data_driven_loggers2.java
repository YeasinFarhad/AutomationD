...
public class express_data_driven_loggers2 extends Abstract_Class {
    ...
    @Test
    public void ExpressCheckout() throws IOException, BiffException, WriteException, InterruptedException {

        //access readable excel workbook
        readFile = Workbook.getWorkbook(new File("src\\main\\resources\\ExpressBy.xls"));
        // create duplicate workbook to input new data
        writeFile = Workbook.createWorkbook(new File("src\\main\\resources\\ExpressBy_results.xls"), readFile);
        ...
        for (int i = 1; i == 1; i++) {
            ...
            logger.log(LogStatus.INFO, "Navigating to Express home page " + i);
            driver.navigate().to("https://express.com");
            //2.verify title
            String expectedTitle = "Men’s and Women’s Clothing";
            String actualTitle = driver.getTitle();
            if (actualTitle.equals(expectedTitle)) {
                logger.log(LogStatus.PASS,"Home page title matches. Expected title is: " + expectedTitle + "-| Actual title is: " + actualTitle);
            } else {
                logger.log(LogStatus.FAIL,"Home page title does not match. Expected title: " + expectedTitle + " Actual title: " + actualTitle);
            }// end of if else
            ...
            //10. Click on view bag from Popup
            click(driver, "//*[text()='View Bag']", logger, "View Bag");
