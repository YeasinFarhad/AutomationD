...
public class Reusable_Library_Loggers {
    ...
    public static void comparePageTitle(WebDriver driver, String expectedTitle,  ExtentTest loggers, String pageName) throws InterruptedException {
        ...
        if(actualTitle.equals(expectedTitle)){
            ...
            loggers.log(LogStatus.PASS,"Title Match. The title is "+actualTitle);
        } else {
